...
Dieses Kapitel legt die Umsetzung der Theorie. Dazu wird im ersten Abschnitt die Kommunikation mit der Smartcard beschrieben. Im zweiten Abschnitt werdne die Datenstrukturen erläutert und im dritten bzw. vierten Abschnitt der On- bzw. Off-Card Teil des Programms.

\input{tex/UmsetzungSU}

\input{tex/UmsetzungDT}

\input{tex/UmsetzungOn}

\input{tex/UmsetzungOff}
